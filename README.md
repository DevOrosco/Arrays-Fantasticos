# Arrays-Fantasticos
### Exercício de Algoritmo e Lógica de Programação com Arrays proposta em aula pelo Instituto Proa
## Objetivo da Atividade:
    Exercitar e fixar a criação e utilização de Arrays e seus métodos em código
